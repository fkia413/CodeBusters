...
with app.app_context():
    ...
    user2 = User(user_email='test2@wow.com', username='user2', first_name='Jane', last_name='Smith', hash='hashed_password', salt='random_salt')
    ...
    # Create movies
    movie1 = Movie(title='Movie 1', release_date=datetime(2023, 9, 10, 16, 0, 0), poster_path='/path/to/poster1.jpg', status='Released', classification_id=1)
    movie2 = Movie(title='Movie 2', release_date=datetime(2023, 9, 10, 16, 0, 0), poster_path='/path/to/poster2.jpg', status='Released', classification_id=2)
    ...
    # Create bookings
    booking1 = Booking(booking_id=1, movie_id=1, screening_time=datetime(2023, 9, 10, 16, 0, 0), n_seats=2, user_email='user1@example.com', ticket_type='Standard', concession=False)
    booking2 = Booking(booking_id=2, movie_id=2, screening_time=datetime(2023, 9, 10, 16, 0, 0), n_seats=3, user_email='user2@example.com', ticket_type='VIP', concession=True)

    # Create payments
    payment1 = Payment(payment_id=1, booking_id=1, timestamp=datetime(2023, 9, 10, 16, 0, 0), card_holder_name='John Doe', card_number='**** **** **** 1234', expiry_date='12/25', security_code='123', amount=25.0, status='Successful')
    payment2 = Payment(payment_id=2, booking_id=2, timestamp=datetime(2023, 9, 10, 16, 0, 0), card_holder_name='Jane Smith', card_number='**** **** **** 5678', expiry_date='12/24', security_code='456', amount=30.0, status='Successful')
    ...
    post1 = DiscussionBoard(post_id=1, user_email='user1@example.com', content='This is a discussion post by John Doe.', timestamp=datetime(2023, 9, 10, 16, 0, 0))
    post2 = DiscussionBoard(post_id=2, user_email='user2@example.com', content='This is a discussion post by Jane Smith.', timestamp=datetime(2023, 9, 10, 16, 0, 0))
